...
import terra.actions.MagicitePowerAction;
...
public class DefaultUncommonPower extends CustomCard {
     ...
     *
     * In order to understand how image paths work, go to defaultmod/TerraMod.java, Line ~140 (Image path section).
     *
    ...
    public static final String IMG = TerraMod.makePath(TerraMod.DEFAULT_UNCOMMON_POWER);
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new MagicitePowerAction(p, m, this.magicNumber,
