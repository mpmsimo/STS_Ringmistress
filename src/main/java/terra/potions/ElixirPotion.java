...
public class ElixirPotion extends AbstractPotion {


    public static final String POTION_ID = terra.TerraMod.makeID("ElixirPotion");
    ...
    public ElixirPotion() {
        // The bottle shape and inside is determined by potion size and color. The actual colors are the main TerraMod.java
        super(
                NAME,
                POTION_ID,
                PotionRarity.COMMON,
